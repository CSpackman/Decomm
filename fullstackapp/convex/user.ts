...
export const initUser = mutation(async ({ db }, wallet: string, firstName?: string, lastName?: string, shippingAddress?: string, email?: string, history?: Array<string>) => {
  const user = {wallet, firstName, lastName, shippingAddress, history}
